 ...
 * Time: 11:23
 */
class Training_Recap_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('training_recap_grid');
    ...
    {
        $helper = Mage::helper('training_recap');
        ...
        $this->addColumn('action', array(
            ...
            'type'    => 'action',
            'renderer'  => 'Training_Recap_Block_Adminhtml_Sales_Order_Renderer_Red',
            'filter'    => false,
            'sortable'  => false
        ));
